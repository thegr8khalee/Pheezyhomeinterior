    ...
    <div className="pt-15">
      ...
      {isAdmin ? (
        <div className="space-y-2 m-2">
          <button
            className="btn rounded-full text-white bg-primary mr-2 w-full"
            onClick={() => handleEditCollection(collectionId)}
          >
            <Pen /> Edit Collection
          </button>
          <button
            className="btn rounded-full w-full btn-error"
      ...
      {!isAdmin ? (
        <div className="px-4 mb-6 sm:flex space-x-2 space-y-2">
          ...
          <button
            className="btn btn-primary  flex-3 w-full text-white rounded-full font-[poppins] shadow-none border-0"
          ...
          {isInWishlist(collectionId) ? (
            <button
              className="btn btn-primary flex-3 w-full rounded-full font-[poppins] shadow-none"
              onClick={() =>
            ...
            <button
              className="btn btn-outline btn-primary flex-3 w-full rounded-full font-[poppins] shadow-none"
