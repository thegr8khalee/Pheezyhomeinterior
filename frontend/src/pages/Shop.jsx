...
const Shop = () => {
  ...
  const whatsappPhoneNumber = '2348066258729'; // Your actual WhatsApp number
      ...
      <div className="px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex justify-center my-5">
          <div className="tabs tabs-boxed space-x-4">
            <button
              type="button"
              className={`btn tab rounded-full ${
                viewMode === 'products' ? 'tab-active bg-primary text-white' : ''
              }`}
            ...
            <button
              type="button"
              className={`btn tab rounded-full ${
                viewMode === 'collections' ? 'tab-active bg-primary text-white' : ''
              }`}
          ...
          <>
            <div className="sm:flex w-full my-5">
              ...
              <div className="form-control w-full">
                <div className="relative">
                  ...
                  <input
                    ...
                    className="input input-bordered w-full pl-10 pr-3 rounded-full"
              ...
              <div className="form-control w-full sm:ml-2 sm:mt-0 mt-2 sm:w-auto">
                <button
                  type="button"
                  className="btn text-white btn-primary rounded-full w-full"
                        ...
                        isInWishlist(product._id) ? (
                          ...
                          >
                            {isRemovingFromWishlist ? (
                              ...
                              <Heart className="text-white size-7 fill-white" />
                            )}
                          </button>
                        ) : (
                          <button
                            ...
                            <div>
                              {!isAdmin ? (
                                <div className="space-x-1">
                                  ...
                                  <button
                                    type="button"
                                    className="btn text-white rounded-full bg-primary"
                                    onClick={() =>
              ...
              <div className="form-control w-full">
                <div className="relative">
                  ...
                  <input
                    ...
                    className="rounded-full input input-bordered w-full pl-10 pr-3"
            ...
            {hasMoreCollections && (
              <div className="flex justify-center mt-8">
                <button
                  ...
                  className="mb-4 btn bg-primary text-white px-8 py-3 rounded-full font-semibold"
                >
                  {!isGettingCollections ? (
                    'Load More'
                  ) : (
