        ...
        <div className="card-body p-8">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="form-control">
              <button
                type="submit"
                className="btn btn-primary w-full border-0 font-semibold py-3  shadow-md hover:shadow-lg transition duration-200 rounded-full text-white text-sm font-['poppins']"
                disabled={isResettingPassword}
              >
                {isResettingPassword ? (
