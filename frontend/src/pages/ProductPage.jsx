        ...
        <div className="md:w-1/2 space-y-1">
          ...
          {!isAdmin ? (
            <div className="flex space-x-4 mb-6">
              <button
                className="btn btn-primary text-white flex-1 rounded-full font-[poppins] shadow-none border-0"
              ...
              {isInWishlist ? (
                <button
                  className="btn btn-primary flex-1 rounded-full font-[poppins] shadow-none"
                ...
                <button
                  className="btn btn-outline btn-primary flex-1 rounded-full font-[poppins] shadow-none"
