      ...
      <div className="relative">
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent">
          <h1 className="absolute bottom-10 left-1/2 -translate-x-1/2 mt-20 w-full mb-2 text-3xl font-bold text-center text-base-100 font-[poppins]">
            Terms and Conditions for PheezyHomesInteriors
          </h1>
      ...
      <div className="w-full justify-center flex p-4">
        <div className="w-full space-y-2 flex flex-col max-w-7xl font-[montserrat]">
          ...
          <div className="border-b border-base-200 pb-4">
            ...
            <h4 className="font-semibold font-[poppins] mt-4 mb-2">
              PAYMENT DETAILS
            </h4>
          ...
          <div className="border-b border-base-200 pb-4">
            ...
            <ul className="list-disc list-inside ml-4 space-y-1 text-sm">
              <li>
                All finishing projects are executed based on the client's
              ...
              <li>
                Any changes to designs, materials, or scope of work after
                project commencement may incur additional charges and affect the
                timeline.
              </li>
            </ul>
          </div>
