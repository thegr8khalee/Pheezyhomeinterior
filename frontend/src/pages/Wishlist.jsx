      ...
      <div className="container mx-auto p-2 sm:p-6 lg:p-8">
        <div className="flex flex-col lg:flex-row gap-8">
                      ...
                      <div className="flex items-center justify-between space-x-2 w-full">
                        ...
                        <div className="flex">
                          <button
                            ...
                            className="btn btn-sm bg-primary text-white rounded-full"
                          ...
                          <button
                            ...
                            className="btn btn-sm btn-error btn-outline rounded-full ml-2"
          ...
          <div className="lg:w-1/3 bg-base-100 p-6 rounded-lg shadow-xl">
            ...
            <Link
              to="/shop"
              className="btn bg-primary text-white w-full mt-8 rounded-full font-[poppins]"
            >
              Continue Shopping
            </Link>
          </div>
