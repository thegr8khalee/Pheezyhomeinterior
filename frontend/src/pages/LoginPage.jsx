          ...
          {!showForgotPasswordForm ? (
            <form onSubmit={handleSubmit}>
              ...
              <div className="form-control">
                <button
                  type="submit"
                  className="btn btn-primary w-full border-0 font-semibold text-white py-3 rounded-full shadow-md hover:shadow-lg transition duration-200  text-sm font-['poppins']"
